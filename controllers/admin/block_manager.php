...
if ($mode == 'manage' || $mode == 'manage_in_tab') {
	...
	$unique_blocks = Bm_SchemesManager::filter_by_location(Bm_Block::instance()->get_all_unique(DESCR_SL), $selected_location['dispatch']);
	$block_types = Bm_SchemesManager::filter_by_location(Bm_SchemesManager::get_block_types(DESCR_SL), $selected_location['dispatch']);
