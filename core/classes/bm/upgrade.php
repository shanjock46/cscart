...
//		$containers = Bm_Container::instance()->get_list_by_area($location['location_id'], 'C');
	...
	public function clear_tables() {
		db_query("TRUNCATE  `cscart_bm_blocks`");
		db_query("TRUNCATE  `cscart_bm_blocks_content`");
		db_query("TRUNCATE  `cscart_bm_blocks_descriptions`");
		db_query("TRUNCATE  `cscart_bm_containers`");
		db_query("TRUNCATE  `cscart_bm_grids`");
		db_query("TRUNCATE  `cscart_bm_grids_descriptions`");
		db_query("TRUNCATE  `cscart_bm_locations`");
		db_query("TRUNCATE  `cscart_bm_locations_descriptions`");
		db_query("TRUNCATE  `cscart_bm_snapping`");
	}
