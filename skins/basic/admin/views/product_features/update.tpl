...
<div class="cm-tabs-content" id="tabs_content_{$id}">
	...
	<fieldset>
		...
		{include file="views/companies/components/company_field.tpl" title=$lang.vendor name="feature_data[company_id]" id="feature_data_`$id`" selected=$feature.company_id}
...
<div class="buttons-container">
	...
	{if !$feature|fn_allow_save_object:"product_features" && $mode != "add"}
