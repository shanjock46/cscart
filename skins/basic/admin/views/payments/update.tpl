...
<div class="cm-tabs-content" id="tabs_content_{$id}">
	...
	<fieldset>
		...
		{if !$hide_fields}
			{include file="views/companies/components/company_field.tpl" title=$lang.vendor name="payment_data[company_id]" id="payment_data_`$smarty.request.payment_id`" selected=$payment.company_id}
		{/if}
