...
<tr class="{if ("COMPANY_ID"|defined && $user.company_id != $smarty.const.COMPANY_ID) || ($user.user_id == $smarty.session.auth.user_id)}cm-hide-inputs{/if} {cycle values="table-row, "}">
