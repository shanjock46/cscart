...
<tr>
	...
	<th width="25%"><a class="cm-ajax{if $search.sort_by == "storefront"} sort-link-{$search.sort_order}{/if}" href="{$c_url}&amp;sort_by=storefront&amp;sort_order={$search.sort_order}" rev="pagination_contents">{$lang.storefront}</a></th>
