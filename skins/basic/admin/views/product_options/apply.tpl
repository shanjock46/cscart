...
{if "COMPANY_ID"|defined}
	{assign var="company_id" value=$smarty.const.COMPANY_ID}
{/if}
...
<p>
	<label class="label-html-checkboxes">
		...
		{assign var="company_name" value=$po.company_id|fn_get_company_name}
		{assign var="store_name" value=" (`$lang.store`: `$company_name`)"}
		{assign var="option_name" value="`$option_name``$store_name`"}
