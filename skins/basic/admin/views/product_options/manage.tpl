...
{foreach from=$product_options item="po"}
	...
	{*if "COMPANY_ID"|defined && $product_data.shared_product == "Y"*}
	{if "COMPANY_ID"|defined && (($product_data.shared_product == "Y" && $smarty.const.COMPANY_ID != $product_data.company_id) || ($object == "global" && $smarty.const.COMPANY_ID != $po.company_id))}
