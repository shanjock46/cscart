...
{if "COMPANY_ID"|defined && $promotion_data.company_id != $smarty.const.COMPANY_ID && $mode != "add"}
...
<fieldset>
	...
	{include file="views/companies/components/company_field.tpl" title=$lang.vendor name="promotion_data[company_id]" id="promotion_data_`$id`" selected=$promotion_data.company_id}
...
<div class="buttons-container buttons-bg">
	...
	{if !$promotion_data|fn_allow_save_object:"promotions" && $mode != "add"}
