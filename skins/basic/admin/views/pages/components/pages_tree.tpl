...
{if "COMPANY_ID"|defined && $page.company_id != $smarty.const.COMPANY_ID}
	{assign var=ult_hide_delete_button value=true}
{else}
	{assign var=ult_hide_delete_button value=false}
{/if}
