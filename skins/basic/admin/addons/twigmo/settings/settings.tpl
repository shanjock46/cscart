...
<fieldset>
	...
	$(function(){
        ...
        jQuery.getScript("{/literal}{if 'HTTPS'|defined}https{else}http{/if}://twigmo.com/download/skins2/{$smarty.const.TWIGMO_VERSION}/skins.js{literal}", function() {
            ...
            if ('TWGGlobal' in window){
                for (i in TWGGlobal.skins){
                    ...
                    $('#skinsPrevContainer').append('<img height="' + imgHeight + '" id="skinPrev_' + i + '" src="{/literal}{if 'HTTPS'|defined}https{else}http{/if}{literal}://twigmo.com/download/skins2/{/literal}{$smarty.const.TWIGMO_VERSION}{literal}/' + i + '.jpg">');
                }
            } else {
