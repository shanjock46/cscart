	...
	<div id="import_step_2">
		...
		<form action="{""|fn_url}" method="POST" name="import_step_2" class="cm-form-highlight cm-comet cm-ajax" enctype="multipart/form-data">
			<fieldset>
				...
				<div class="form-field">
					<label for="store_data_storefront" class="cm-required">{$lang.es_storefront_url}:</label>
						<input type="text" name="store_data[storefront]" id="store_data_storefront" size="44" value="{$store_data.storefront}" class="input-text"/>
				</div>
				<div class="form-field">
					<label for="store_data_secure_storefront">{$lang.es_secure_storefront_url}:</label>
