	...
	{if $show_entry_page}
		<div id="entry_page"></div>
			<script type="text/javascript">
				$('#entry_page').ceDialog('open', {$ldelim}href: fn_url('companies.entry_page'), resizable: false, title: '{$lang.choose_your_country}', width: 325, height: 420, dialogClass: 'entry-page'{$rdelim});
			</script>
	{/if}
